...
$url="https://api.chat-api.com/instance252420/message?token=b1zx2kxg21avodth";
...
<html lang="en">
  ...
  <body>
    <div style="height: 100vh;max-width:500px;" class="container d-flex justify-content-center align-items-center">
    <form class="row g-3">
  <div class="col-md-6">
